 ...
 * 
 * Write a function that returns a lazy sequence of "pronunciations" of a list of numbers. A pronunciation of each
 * element in the list consists of the number of repeating identical numbers and the number itself. For example,
